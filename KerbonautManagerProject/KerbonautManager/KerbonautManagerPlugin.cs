...
public class KerbonautManagerPlugin : BaseSpaceWarpPlugin
{
    ...
    private readonly Dictionary<Panel, GameObject> _kerbalPanels = new() { { Panel.A, null }, { Panel.B, null } };
    ...
    private static void AddPanelKerbals(Panel panel, GameObject location)
    {
        ...
        var kerbalList = panelObject.GetComponent<ContextBindRoot>().Context.GetStackParent()
